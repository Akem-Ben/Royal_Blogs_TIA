...
const AdvertBanner = () => {
    ...
    return (
        ...
        <div style={{width: '600px', display: 'flex', borderRadius: '50px', color: '#6A6975', justifyContent: 'center', alignItems: 'center'}}>
        <Card style={{ border: `${theme === 'light' ? '#E8E8EA' : '#242535'}`, borderRadius: '10px', backgroundColor: `${theme === 'light' ? '#E8E8EA' : '#242535'}`, width: '100%', display: 'flex', color: '#6A6975', justifyContent: 'center', alignItems: 'center', textAlign: 'center'}}>
      <Card.Body>
